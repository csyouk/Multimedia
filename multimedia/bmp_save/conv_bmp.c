/* source:http://gaiger-programming.blogspot.kr/2015/03/control-usb-camera-in-linux.html*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
...
#define DATA_STORE_LEN         (1024*1024)
...
*/
 ...
 preferWidth = 640; preferHeight = 480;
 ...
 if(fmt.fmt.pix.width != preferWidth
  || fmt.fmt.pix.height != preferHeight)
 {
